...
export function SeeLiveDialog({ open, onOpenChange, featuredUnits }: SeeLiveDialogProps) {
  const { isAvailable, users, open: openViewProWidget } = useViewProWidget();
        ...
        <div className="min-h-0 flex-1 overflow-x-hidden overflow-y-auto">
              ...
              [
                {
                  ...
                  body: 'See any van in real time from any angle.',
                },
                {
                  Icon: MessageCircle,
                  title: 'Ask questions',
          ...
          <div className="border-t border-neutral-100 px-4 py-5 sm:px-6 sm:py-6">
            ...
            {featuredUnits.length === 0 ? (
              <p className="text-muted-foreground py-6 text-center text-sm">No vans to show right now.</p>
            ) : (
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-black tracking-wide text-neutral-900 uppercase sm:text-base">
                    Connect with a van specialist
                  </p>
                  <p className="mt-1 text-xs leading-relaxed text-neutral-600 sm:text-sm">
                    We&apos;re online and ready to show you vans, answer questions, and help you find the right one.
                  </p>
